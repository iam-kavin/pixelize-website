  ...
  return (
    <>
      <div className={classes.HeaderCard}>
        <Navigation />
        <h3>
          We Provide Web and App Development Services for Startups and SMBs
        </h3>
        <div className={classes.HeaderCard_para}>
          <p>
            We help businesses achieve digital transformation through our
            customized scalable white label solutions. Our team of experts will
            help you
          </p>
        </div>
      </div>
      ...
      <div className="ml-5 mt-5 mb-5 mr-5 max-w-full md:ml-10 md:mt-10 md:mb-20 lg:ml-20 lg:mt-60 lg:mb-20 max-w-4xl h-auto relative ">
        <p className="text-base md:text-3xl lg:text-3xl font-light leading-6 md:leading-10 lg:leading-10 text-left">
          At Pixelize, we're your one-stop shop for crafting exceptional digital
          products and propelling them to success. We're a passionate team of
          <span className="font-medium">
            developers, designers, and marketing experts{" "}
          </span>
          who believe in the power of collaboration. We partner with businesses
          like yours to bring your vision to life, from the initial concept to
          launch and beyond.
        </p>
      </div>
      ...
      <div className="flex flex-col items-end mr-4 mb-10 md:mr-6 md:mb-30 lg:mr-9 lg:mb-40 relative">
        ...
        <h4 className="h-16 text-3xl md:text-4xl lg:text-6xl font-light leading-tight text-right text-black">
          Solutions Customized for Diverse Requirements
        </h4>
      </div>
      ...
      <div className="w-[97%] flex justify-end h-20 mt-[80px] mb-[50px] relative">
        <h4 className="text-7xl font-light leading-[80px] text-right text-black">
          ...
          {BenefitsCardData.map((OneCardData) => (
            ...
            >
              <div className="bg-white shadow-lg rounded-xl overflow-hidden transform transition duration-500 hover:scale-105 h-full flex flex-col">
                <img
                  src={OneCardData.imageUrl}
                  alt={OneCardData.title}
                  className="w-full h-32 object-cover"
                />
                <div className="p-6 flex flex-col flex-grow">
                  <div className="flex items-center mb-5">
                    <FaReact className="text-indigo-600 mr-2" />{" "}
                    {/* React Icon */}
                    <h5 className="text-2xl font-bold">{OneCardData.title}</h5>
                  </div>
                  <p className="text-gray-700 mb-4">
                    {OneCardData.description}
                  </p>
                  <ul className="list-disc list-inside space-y-2">
                    {OneCardData.list.map((item) => (
                      <li key={item} className="text-gray-600 mb-6 leading-7">
                        {item}
                      </li>
                    ))}
                  </ul>
      ...
      <div className={classes.links_container}>
        <Link href={"/SignupPage"} className={classes.link1}>
          Get a Free Consultation
        </Link>
        <Link href={"/ServicePage"} className={classes.link2}>
          Learn More About Our Services
          <BsArrowUpRight fontSize="1em" strokeWidth="1.5" />
        </Link>
      </div>
...
const HelpCardData = [
  {
    ...
    list: [
      "Design Thinking - led Product Discovery ",
      "Digital Platform & ProductManagement",
  ...
  },
  {
    ...
    list: [
      ...
      "Embedded Engineering Ecosystem",
    ],
  },
  {
    title: "Empower",
...
const BenefitsCardData = [
  {
    ...
    list: [
      "Transparent Communication: We prioritize clear and open communication to ensure your vision and goals are fully understood and implemented.",
  ...
  },
  {
    ...
    list: [
      "Efficient Processes: Our streamlined development processes are designed to accelerate project timelines without compromising on quality.",
  ...
  },
  {
    ...
    list: [
      "Custom Development: We build tailored solutions that are designed to grow with your business and adapt to changing market demands.",
  ...
  },
  {
    ...
    list: [
      "Data-Driven Approach: We use analytics and data-driven insights to guide our development process and optimize your web solutions for performance and user engagement.",
